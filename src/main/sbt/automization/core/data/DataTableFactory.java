...
public final class DataTableFactory
{
    ...
    private static void sortSamples(Probe table)
    {
        ...
        {
            table.getSamples()
                 .sort(Comparator.comparing(a -> Integer.parseInt(a.get(SampleKey.NUMBER))));
        } catch (Exception e)
        {
            ErrorPopup.showMessage(
                    "Es fehlt eine Nummerierung der Samples. Demnach kann eine Sortierung nicht durchgeführt werden.");
        }
    }
