...
import sbt.automization.core.templates.appendix.site08.*;

import java.util.List;

public final class ExplorationSite08 extends Appendix
{
	private static ExplorationSite08 instance;
	
	private ExplorationSite08()
	{
	}
	
	public static ExplorationSite08 getInstance()
	{
		if (instance == null)
		{
			synchronized (ExplorationSite08.class)
			{
				if (instance == null)
				{
					instance = new ExplorationSite08();
				}
			}
		}
		return instance;
