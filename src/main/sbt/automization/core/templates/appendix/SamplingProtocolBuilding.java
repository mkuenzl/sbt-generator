	...
	protected String constructAndGetTableHeader()
	{
		String firstRow = HtmlFactory.createRowAsString(BuildingStyle.ROW_THIN_8.getStyleClass(), new String[]{
				...
				HtmlFactory.createHeaderAsString(BuildingStyle.HEADER_CELL.getStyleClass(), "width:2.5cm",
						new String[]{"Farbe"}),
				HtmlFactory.createHeaderAsString(BuildingStyle.HEADER_CELL.getStyleClass(), "width:2cm",
						new String[]{"Tiefe"}),
				HtmlFactory.createHeaderAsString(BuildingStyle.HEADER_CELL.getStyleClass(), "width:1.1cm",
						new String[]{"Probe"}),
				HtmlFactory.createHeaderAsString(BuildingStyle.HEADER_CELL.getStyleClass(), "width:1.4cm",
						new String[]{"Chemie"}),
