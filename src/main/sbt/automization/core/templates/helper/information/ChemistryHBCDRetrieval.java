...
public class ChemistryHBCDRetrieval extends DatatableInformationRetrieval
{
	public ChemistryHBCDRetrieval()
	{
		super(ChemistryKey.HBCD);
	}
...
//						new String[]{"HBCD,", formatUnit("mg/kg")})
//		});
//
//		return row;
//	}
