...
public class ChemistryFCKWRetrieval extends DatatableInformationRetrieval
{
	public ChemistryFCKWRetrieval()
	{
		super(ChemistryKey.FCKW);
	}
...
//						new String[]{"FCKW,", formatUnit("mg/kg")})
//		});
//
//		return row;
//	}
