...
public final class BanquetReport
		extends AbstractReport
{
	private static BanquetReport instance;
	private final RowFactory provider;
	
	private BanquetReport()
	{
		super(Outcrop.BANQUET);
		provider = new RowFactory(Outcrop.BANQUET);
	}
	
	public static BanquetReport getInstance()
	{
		if (instance == null)
		{
			synchronized (BanquetReport.class)
			{
				if (instance == null)
				{
					instance = new BanquetReport();
				}
			}
		}
		return instance;
