...
public final class HeapReport
		extends AbstractReport
{
	private static HeapReport instance;
	...
	public static HeapReport getInstance()
	{
		if (instance == null)
		{
			synchronized (HeapReport.class)
			{
				if (instance == null)
				{
					instance = new HeapReport();
				}
			}
		}
		return instance;
