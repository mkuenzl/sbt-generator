...
public final class NumberTextFormatter extends AbstractTextFormatter
{
	@Override
	...
	{
		return replaceIfEmpty(formatStringToTwoDecimals(firstText)).concat(" ").concat(replaceIfEmpty(formatStringToTwoDecimals(secondText)));
	}
