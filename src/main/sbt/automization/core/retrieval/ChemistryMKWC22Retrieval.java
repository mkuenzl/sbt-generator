...
public class ChemistryMKWC22Retrieval extends DatatableInformationRetrieval
{
	public ChemistryMKWC22Retrieval()
	{
		super(ChemistryKey.MKW_C22);
	}
...
//						new String[]{"MKW, (C10 - C22)", formatUnit("mg/kg")})
//		});
//
//		return row;
//	}
