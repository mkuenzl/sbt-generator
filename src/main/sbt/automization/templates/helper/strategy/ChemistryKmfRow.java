...
public class ChemistryKmfRow extends RowConstruction
{
	public ChemistryKmfRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
		super(probes, outcrop, key, styleParameter);
	}

	public ChemistryKmfRow()
	{
		super(ChemistryKey.KMF);
	}
	...
	HtmlRow createRow()
	{
		HtmlRow row = HtmlFactory.createRow(styleParameter.getRowClass(), new HtmlCell[]{
				HtmlFactory.createCell(styleParameter.getHeaderCellClass(), styleParameter.getHeaderCellWidth(),
						new String[]{"KMF,", formatUnit("Nachweisgrenze")})
		});
