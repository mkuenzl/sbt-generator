...
public class MaterialBuildingRow extends RowConstruction
{
	public MaterialBuildingRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
		super(probes, outcrop, key, styleParameter);
	}

	public MaterialBuildingRow()
	{
