...
public class ChemistryDecisionSupport extends RowConstructionStrategy
{
	...
	{
		String depvDecisionSupport = new SamplePrinter().printAttributeOfSamplesWithDepth(table, outcrop, key);
