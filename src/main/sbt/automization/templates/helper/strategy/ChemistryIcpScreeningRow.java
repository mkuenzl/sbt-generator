...
public class ChemistryIcpScreeningRow extends RowConstruction
{
	public ChemistryIcpScreeningRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
		super(probes, outcrop, key, styleParameter);
	}

	public ChemistryIcpScreeningRow()
	{
