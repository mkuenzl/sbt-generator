...
public class SizeTotalTmhbRow extends RowConstruction
{
	public SizeTotalTmhbRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
		super(probes, outcrop, key, styleParameter);
	}

	public SizeTotalTmhbRow()
	{
		super(SampleKey.ID);
	}
