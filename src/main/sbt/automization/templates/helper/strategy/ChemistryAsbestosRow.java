...
public class ChemistryAsbestosRow extends RowConstruction
{
	public ChemistryAsbestosRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
