...
public class WaterContentRow extends RowConstruction
{
	...
	{
		String waterContent = new SamplePrinter().printAttributeOfSamplesWithDepth(probe, outcrop, key);
