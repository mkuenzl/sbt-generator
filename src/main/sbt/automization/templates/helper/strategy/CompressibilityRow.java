...
public class CompressibilityRow extends RowConstructionStrategy
{
	...
	{
		String compressibility = new SamplePrinter().printAttributeOfSamplesWithDepth(table, outcrop, key);
