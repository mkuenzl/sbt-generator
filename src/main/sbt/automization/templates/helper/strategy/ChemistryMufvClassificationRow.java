...
public class ChemistryMufvClassificationRow extends RowConstruction
{
	public ChemistryMufvClassificationRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
	...
	{
		String attributeOfSamples = new SamplePrinter().printAttributeOfSamplesWithDepth(probe, outcrop, key);

		HtmlCell cell = HtmlFactory.createCell(styleParameter.getTextFormatter(),
				styleParameter.getNormalCellClass(),
				styleParameter.getNormalCellWidth(),
				new String[]{attributeOfSamples});
