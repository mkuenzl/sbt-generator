...
public class ChemistryPhenolRow extends RowConstruction
{
	public ChemistryPhenolRow(List<DataTable> probes, String outcrop, Key key, StyleParameter styleParameter)
	{
